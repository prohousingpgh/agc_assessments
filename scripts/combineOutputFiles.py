...
model_groups = ["residential_single_family_suburban", "residential_single_family_suburban_prewar", "residential_single_family_urban", "residential_multi_family", "commercial"]
...
school_district_valuation_ratios = valuation_ratios.groupby(['school_district'])['VALUATION_RATIO'].median().reset_index()
school_district_valuation_ratios.rename(columns={'VALUATION_RATIO': 'school_district_valuation_ratio'}, inplace=True)
parcel_data = parcel_data.merge(school_district_valuation_ratios, how='left', left_on=['school_district'], right_on=['school_district'])
school_district_valuation_ratios.to_csv("school_district_valuation_ratios.csv", index=False)
municipality_valuation_ratios = valuation_ratios.groupby(['municipality'])['VALUATION_RATIO'].median().reset_index()
municipality_valuation_ratios.rename(columns={'VALUATION_RATIO': 'municipality_valuation_ratio'}, inplace=True)
parcel_data = parcel_data.merge(municipality_valuation_ratios, how='left', left_on=['municipality'], right_on=['municipality'])
municipality_valuation_ratios.to_csv("municipality_valuation_ratios.csv", index=False)
city_council_district_valuation_ratios = valuation_ratios.groupby(['city_council_district'])['VALUATION_RATIO'].median().reset_index()
city_council_district_valuation_ratios.rename(columns={'VALUATION_RATIO': 'city_council_district_valuation_ratio'}, inplace=True)
parcel_data = parcel_data.merge(city_council_district_valuation_ratios, how='left', left_on=['city_council_district'], right_on=['city_council_district'])
city_council_district_valuation_ratios.to_csv("city_council_district_valuation_ratios.csv", index=False)
county_council_district_valuation_ratios = valuation_ratios.groupby(['county_council_district'])['VALUATION_RATIO'].median().reset_index()
county_council_district_valuation_ratios.rename(columns={'VALUATION_RATIO': 'county_council_district_valuation_ratio'}, inplace=True)
parcel_data = parcel_data.merge(county_council_district_valuation_ratios, how='left', left_on=['county_council_district'], right_on=['county_council_district'])
county_council_district_valuation_ratios.to_csv("county_council_district_valuation_ratios.csv", index=False)
...
parcel_data[parcel_data['CLASS'] == 'R'].to_csv("residential_predictions.csv", header=['PARCEL_ID', 'USE_DESCRIPTION', 'MUNICIPALITY', 'SCHOOL_DISTRICT', 'LAND_AREA_SQFT', 'BUILDING_AREA_SQFT', 'TAXABLE', 'CURRENT_ASSESSMENT_LAND', 'CURRENT_ASSESSMENT_TOTAL', 'NEW_ASSESSMENT_LAND', 'NEW_ASSESSMENT_TOTAL', 'VALUATION_RATIO'], columns=['PARID', 'USEDESC', 'municipality', 'school_district', 'land_area_sqft', 'building_area', 'TAXDESC', 'assessed_land', 'assessed_total', 'census_tract_lycd_land_prediction_mean', 'total_prediction', 'VALUATION_RATIO'], index=False)
parcel_data[parcel_data['CLASS'] != 'R'].to_csv("commercial_existing_valuations.csv", header=['PARCEL_ID', 'USE_DESCRIPTION', 'MUNICIPALITY', 'SCHOOL_DISTRICT', 'LAND_AREA_SQFT', 'TAXABLE', 'CURRENT_ASSESSMENT_LAND', 'CURRENT_ASSESSMENT_TOTAL'], columns=['PARID', 'USEDESC', 'municipality', 'school_district', 'land_area_sqft', 'TAXDESC', 'assessed_land', 'assessed_total'], index=False)
