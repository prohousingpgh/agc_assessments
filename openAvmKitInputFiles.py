...
# parcel_data['PARCEL_AREA'] = pd.Series(dtype='float')
...
#     if row['PARCEL_ID'] in parcel_geometry_distance.index:
...
#         # Convert to a Cartesian equal area projection to get the area
#         try:
#             s = gpd.GeoSeries([geometry], crs = 3857)
#             s = s.to_crs(6933)
#             parcel_data.at[i, 'PARCEL_AREA'] = s.area[0] * 10.76391
#         except:
#             print('Invalid shape')
#             print(row)
#             print(row.geometry, flush = True)
